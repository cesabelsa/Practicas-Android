...
import com.example.consumoapp.ComoFuncionaActivity;
...
public final class MenuNavigator {
    ...
    public static int resolverOpcionActual(AppCompatActivity activity) {
        ...
        if (activity instanceof SimuladorFacturaActivity) {
            // El simulador agrupa tanto el cálculo como la comparación interna.
            // En el menú lateral se muestra una única entrada: "Simular factura".
            return R.id.action_nav_factura;
        }
        ...
        if (activity instanceof ComoFuncionaActivity) {
    ...
    public static boolean handleNavigation(AppCompatActivity activity, int itemId) {
        ...
        if (itemId == R.id.action_nav_onboarding) {
            abrirPantalla(activity, ComoFuncionaActivity.class, false);
            return true;
        }

...
public class HotelAdapter extends RecyclerView.Adapter<HotelAdapter.HotelViewHolder> {
    ...
    // Listener que se ejecuta cuando el usuario pulsa una tarjeta de hotel.
    private OnHotelClickListener onHotelClickListener;

    /**
     * Interfaz sencilla para avisar al Fragment de que se ha seleccionado un hotel.
     */
    ...
    static class HotelViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Hotel hotel) {
            ...
            // Al pulsar sobre la tarjeta, avisamos al Fragment para abrir Google Maps.
            binding.getRoot().setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    RecyclerView.Adapter adapter = getBindingAdapter();
                    if (adapter instanceof HotelAdapter) {
                        HotelAdapter hotelAdapter = (HotelAdapter) adapter;
                        if (hotelAdapter.onHotelClickListener != null) {
                            hotelAdapter.onHotelClickListener.onHotelClick(hotel);
                        }
                    }
                }
            });
